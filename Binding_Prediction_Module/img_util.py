...
class Voxelizer3D(nn.Module):
	...
	#def __init__(self, feat_dim=5, vol_dim=48, ang_size=48, relative_size=True, atom_radius=1, use_cuda=True,verbose=0):
	def __init__(self, feat_dim=8, vol_dim=48, ang_size=48, relative_size=True, atom_radius=1, use_cuda=True,
				verbose=0):
